...
namespace IMChatApp.Hubs
{
	...
	public class ChatHub : Hub
	{
		...
		static List<Usuario> loggedInUsers = new List<Usuario>();
		...
		public string Login(string name)
		{
			...
			string sJSON = Newtonsoft.Json.JsonConvert.SerializeObject(loggedInUsers);
		...
		public void Connect(string userName)
		{
			...
			{
				loggedInUsers.Add(new Usuario { ConnectionId = id, name = userName });
